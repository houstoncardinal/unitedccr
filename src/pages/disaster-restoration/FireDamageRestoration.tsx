...
const FireDamageRestoration = () => {
  ...
  const processSteps = [
    {
      ...
      description: "Immediate emergency response to assess damage and secure the property"
    },
    {
      step: "2", 
      title: "Damage Assessment",
      description: "Comprehensive evaluation of fire, smoke, and water damage extent"
    },
    {
      step: "3",
      title: "Cleanup & Restoration",
      description: "Professional cleanup, deodorization, and structural restoration"
    },
    {
      step: "4",
      title: "Final Inspection",
      description: "Complete quality inspection to ensure restoration meets standards"
    }
  ];
  ...
  const whyChooseUs = [
    {
      title: "Emergency Response",
      description: "Emergency response for all fire damage situations",
      icon: Clock
    },
    {
      title: "Certified Technicians",
      description: "IICRC certified fire damage restoration specialists",
      icon: Shield
    },
    {
    ...
    },
    {
      ...
      description: "State-of-the-art equipment for complete fire damage restoration",
      icon: Zap
    }
  ];
...
export default FireDamageRestoration; 