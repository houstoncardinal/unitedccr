...
const WaterDamageRestoration = () => {
  ...
  const processSteps = [
    {
      ...
      description: "Immediate emergency response to assess water damage and begin extraction"
    },
    {
      step: "2", 
      title: "Water Extraction",
      description: "Rapid water removal using industrial extraction equipment"
    },
    {
      step: "3",
      title: "Structural Drying",
      description: "Complete structural drying to prevent mold growth"
    },
    {
      step: "4",
      title: "Restoration",
      description: "Full restoration of damaged areas and contents"
    }
  ];
  ...
  const whyChooseUs = [
    {
      title: "Emergency Response",
      description: "Emergency response for all water damage situations",
      icon: Clock
    },
    {
    ...
    },
    {
      ...
      description: "State-of-the-art equipment for complete water damage restoration",
      icon: Zap
    }
  ];
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-white/90 max-w-3xl mx-auto">
              Professional water damage restoration specialists with emergency response. 
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
              From emergency water extraction to complete structural drying and restoration, we handle all aspects of water damage with professional expertise.
            </p>
          </div>
      ...
      <section className="py-20 bg-secondary/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
              We follow a systematic approach to ensure complete water damage restoration and prevent mold growth.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-6 leading-tight">
              Why Choose United CCR for Water Damage Restoration?
            </h2>
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
              As certified water damage restoration specialists, we provide fast response, professional service, and complete restoration solutions.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-primary-dark">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
            Water Damage Emergency? We're Available 24/7/365
          </h2>
